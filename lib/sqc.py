...
ID = lambda x: x
f_mapXread_epd = f_readgen_epd(2**(mapX + 1) - 1, (0, ID))
f_mapYread_epd = f_readgen_epd(2**(mapY + 1) - 1, (0, ID))
f_screenXread_epd = f_readgen_epd(0x3FF, (0, ID))
f_screenYread_epd = f_readgen_epd(0x1FF, (0, ID))
